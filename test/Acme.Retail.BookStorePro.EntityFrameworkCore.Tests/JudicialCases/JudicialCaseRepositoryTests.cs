...
{
    public class JudicialCaseRepositoryTests : BookStoreProEntityFrameworkCoreTestBase
    {
        private readonly IJudicialCaseRepository _judicialCaseRepository;

        public JudicialCaseRepositoryTests()
        {
            _judicialCaseRepository = GetRequiredService<IJudicialCaseRepository>();
        }
        ...
        public async Task GetListAsync()
        {
            ...
            {
                // Act
                var result = await _judicialCaseRepository.GetListAsync(
                ...
                result.First().Id.ShouldBe(Guid.Parse("3d7b76c4-b566-4627-b33c-8b9052c04fb9"));
            });
        }
        ...
        public async Task GetCountAsync()
        {
            ...
            {
                // Act
                var result = await _judicialCaseRepository.GetCountAsync(
