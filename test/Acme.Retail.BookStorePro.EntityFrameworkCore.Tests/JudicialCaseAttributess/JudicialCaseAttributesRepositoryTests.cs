...
{
    public class JudicialCaseAttributesRepositoryTests : BookStoreProEntityFrameworkCoreTestBase
    {
        private readonly IJudicialCaseAttributesRepository _judicialCaseAttributesRepository;

        public JudicialCaseAttributesRepositoryTests()
        {
            _judicialCaseAttributesRepository = GetRequiredService<IJudicialCaseAttributesRepository>();
        }
        ...
        public async Task GetListAsync()
        {
            ...
            {
                // Act
                var result = await _judicialCaseAttributesRepository.GetListAsync(
                ...
                result.First().Id.ShouldBe(Guid.Parse("c3065537-b382-4b38-a4c9-337013b0ebea"));
            });
        }
        ...
        public async Task GetCountAsync()
        {
            ...
            {
                // Act
                var result = await _judicialCaseAttributesRepository.GetCountAsync(
